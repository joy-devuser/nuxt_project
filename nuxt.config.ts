...
const metaDescription =
  "タイププロジェクトは、機能性と独自性を核にした魅力ある書体づくりに挑む21世紀の文字カンパニーです。";
const maxNum = 10;
const _perPage = 24;
...
export default defineNuxtConfig({
  ...
  plugins: ["@/plugins/gsap.ts", "@/plugins/days.ts"],
...
async function fetchWithRetry(
  ...
  try {
    ...
    if (retries > 0) {
      ...
      console.error(
        `Error fetching ${url} after ${MAX_RETRIES} attempts:`,
        error
      );
      throw error;
    }
...
async function fetchRoutes() {
  ...
  const apiEndpoints = [
    ...
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/posts",
      prefix: "/en/news",
    },
    {
      url: "https://tp.joystream.com/wp-json/wp/v2/fontinuse",
      prefix: "/fontinuse",
    },
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/fontinuse",
      prefix: "/en/fontinuse",
    },
    { url: "https://tp.joystream.com/wp-json/wp/v2/fonts", prefix: "/fonts" },
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/fonts",
      prefix: "/en/fonts",
    },
    {
      url: "https://tp.joystream.com/wp-json/wp/v2/service",
      prefix: "/service",
    },
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/service",
      prefix: "/en/service",
    },
    {
      url: "https://tp.joystream.com/wp-json/wp/v2/interviews",
      prefix: "/interviews",
    },
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/interviews",
      prefix: "/en/interviews",
    },
    { url: "https://tp.joystream.com/wp-json/wp/v2/story", prefix: "/story" },
    {
      url: "https://tp.joystream.com/en/wp-json/wp/v2/story",
      prefix: "/en/story",
    },
  ];
